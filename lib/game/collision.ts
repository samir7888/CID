...
const COLLISION_Z_PADDING = 0.45;
...
function getObstacleBox(obstacle: ObstacleConfig) {
  ...
  return {
    ...
    minZ: obstacle.z - obstacle.depth / 2 - COLLISION_Z_PADDING,
    maxZ: obstacle.z + obstacle.depth / 2 + COLLISION_Z_PADDING,
  };
}
 ...
 */
export function isChaserCatchDistance(
...
export function laneOverlapsExisting(
  lane: Lane,
  z: number,
  existingZs: number[],
  minGap: number,
