...
export const MAX_WORLD_SPEED = 34;
...
export const DIFFICULTY_BANDS = [
  ...
  { minScore: 500, label: "medium", speedMultiplier: 1.25, chaserAggression: 0.45 },
  { minScore: 1500, label: "hard", speedMultiplier: 1.55, chaserAggression: 0.7 },
  { minScore: 3000, label: "very-hard", speedMultiplier: 1.85, chaserAggression: 1.0 },
] as const;
